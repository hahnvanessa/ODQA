...
if __name__ == '__main__':
    ...
    qp_bilstm = BILSTM(vocab_size=20000, embedding_dim=300, hidden_dim=100, batch_size=30)
    ...
    for file in file_paths:
        with open(os.path.join(file, 'r')) as f:
            ...
            for item in content:
                ...
                q_representation = qp_bilstm.forward(question)
                contexts = item[item_id]['contexts']
                c_representations = []
                for context in contexts:
                    c_representation = qp_bilstm.forward(context)
